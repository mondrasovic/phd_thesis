...
% ------------------------------------------------------------------------------
\begin{figure}[!t]
    \centerline{\includegraphics[width=0.4\linewidth]{figures/theoretical_foundations/cosine_window.pdf}}
    \caption[Cosine window]{A visualization of $1$D (top) and $2$D (bottom) cosine window under the assumption that the response map is of size $17 \times 17$. The $2$D version can be produced as an outer product of the two vectors corresponding to the $1$D version. Such a mask is very similar to Gaussian probability distribution and conveys the idea of putting the highest weight to the center with nonlinear, even reduction when moving away from the center. However, in this case, the cosine function is used instead.}
...
\end{equation}
\emph{One-shot learning} aims to learn $W$ when only a single exemplar $z$ is available.
...
% ------------------------------------------------------------------------------
\begin{figure}[t]
    \centerline{\includegraphics[width=0.75\linewidth]{figures/theoretical_foundations/siam_rpn_one_shot_detection.pdf}}
...
\begin{figure}[!t]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption[]{}
    \end{subfigure}
    \caption[\Gls{siammask} architecture]{A schematic illustration of the two \gls{siammask} variants: \imgpartdesc{a} a three-branch architecture (full), \imgpartdesc{b} a two-branch architecture (head). Depth-wise correlation layers are adopted again. \externalsrc{\cite{wang2019siammask}}}
