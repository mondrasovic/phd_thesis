...
\noindent The proposed architecture in accordance to the aforementioned observation is described in Fig.~\ref{fig:FullyCNNTrackingFeatureMaps} and Fig.~\ref{fig:FullyCNNTrackingSNetGNet}.
