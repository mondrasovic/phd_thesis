...
\begin{table}[t]
    ...
    \caption[Measures of binary classification]{Elementary measures for evaluating binary classification. \externalsrc{\cite{davis2016prcurves}}}
