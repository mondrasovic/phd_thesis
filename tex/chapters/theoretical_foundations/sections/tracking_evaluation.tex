...
\begin{enumerate}
    ...
    \item reflect the tracker's ability to track objects consistently, \ietext{}, to correctly trace object trajectories such that one and only one trajectory is established per object,
    ...
    \item be general enough so that comparison of different types of trackers, \egtext{} $2$D or $3$D, is possible,
