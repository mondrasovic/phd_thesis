...
\begin{figure}[t]
    ...
    \caption[\Gls{siammot} with attention]{Our proposal to incorporate attention mechanism into the \gls{siammot} pipeline. This diagram shows the relationships between individual parts of the framework during the training phase.}
